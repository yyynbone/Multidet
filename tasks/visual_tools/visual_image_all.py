"""
edit by xeather
a general python file of visual image without requires
"""
...
def visual_return(cocoeval, anno, save_dir, img_prefix, class_area=None, iou_id=0, score_thresh=0.001, cal_bou=False, map_match=False, logger=None):
    ...
    print('coco eval checked and collated \n')
    for imageid, show_info in show_dict.items():
        ...
        all_cat_pred.append(bbox_result)
...
if __name__ == '__main__':
    ...
    print(
        ...
        f"0.5 and conf thresh of {last_conf}")
