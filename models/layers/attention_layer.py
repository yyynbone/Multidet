...
class CBAM(nn.Module):
    def __init__(self, channelIn, ratio=16, kernel_size=7):
        super(CBAM, self).__init__()
        self.channel_attention = ChannelAttention(channelIn, ratio)
...
class CBAMBottleneck(Bottleneck):
    def __init__(self, c1, c2, shortcut=True, g=1, k=(1, 3), e=0.5, ratio=16, kernel_size=7):
        super().__init__(c1, c2, shortcut, g, k, e)
        self.attention = CBAM(c2, ratio, kernel_size)
    def forward(self, x):
...
# Coordinate Attention for Efficient Mobile Network Design  https://arxiv.org/pdf/2103.02907.pdf
